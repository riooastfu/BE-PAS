...
const PersCutiKaryawanDt = db.define(
  ...
  },
  {
    ...
    timestamps: true, // Aktifkan pengelolaan timestamp otomatis
    createdAt: "created_at", // Map kolom 'createdAt' Sequelize ke 'created_at' di DB
    updatedAt: "updated_at", // Map kolom 'updatedAt' Sequelize ke 'updated_at' di DB
  }
);
